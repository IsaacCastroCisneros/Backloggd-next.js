...
export default function Msg() 
{
  ...
  return (
    <>
      {(
        <div className={` pointer-events-none fixed right-[1rem] duration-[200ms] bg-field text-text text-[1.3rem] flex gap-[1rem] items-center px-[.8rem] py-[.4rem] rounded-[.5rem] border-[1px] border-text ${show ? "opacity-1 top-[1rem]":"top-0 opacity-0"} z-[9999999999999999]`}>
